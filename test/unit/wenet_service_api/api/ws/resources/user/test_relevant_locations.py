...
class TestWeNetUserRelevantLocationsInterface(CommonTestCase):
    ...
    def test_get(self):
        ...
        response = self.client.get("/user/profile/profile-id/relevantLocations", headers={"apikey": self.AUTHORIZED_APIKEY, "x-wenet-source": WenetSource.COMPONENT.value})
        self.assertEqual(response.status_code, 200)
        json_data = json.loads(response.data)
        self.assertEqual(profile.relevant_locations, json_data)
    ...
    def test_get_oauth_2(self):
        ...
        response = self.client.get(f"/user/profile/{profile_id}/relevantLocations", headers={
            "apikey": self.AUTHORIZED_APIKEY,
            "x-wenet-source": WenetSource.OAUTH2_AUTHORIZATION_CODE.value,
    ...
    def test_get_not_authorized(self):
        ...
        self.service_collector_connector.profile_manager_collector.get_user_profile = mock_get
        response = self.client.get("/user/profile/1/relevantLocations")
    ...
    def test_put(self):
        ...
        response = self.client.put(f"/user/profile/{profile_id}/relevantLocations", json=relevant_locations, headers={"apikey": self.AUTHORIZED_APIKEY, "x-wenet-source": WenetSource.COMPONENT.value})
        self.assertEqual(200, response.status_code)
    ...
    def test_put_oauth_2(self):
        ...
        response = self.client.put(f"/user/profile/2/relevantLocations", json=relevant_locations, headers={
            "apikey": self.AUTHORIZED_APIKEY,
            "x-wenet-source": WenetSource.OAUTH2_AUTHORIZATION_CODE.value,
    ...
    def test_put_not_authorized(self):
        ...
        response = self.client.put(f"/user/profile/{profile_id}/relevantLocations", json=relevant_locations)
        self.assertEqual(401, response.status_code)
